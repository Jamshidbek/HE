...
class RSA(models.Model):
    ...
    e = models.CharField(max_length=200, verbose_name="Public number E")
    d = models.CharField(max_length=200, blank=True, null=True, verbose_name="Private number D")
...
class Sezar(models.Model):
    ...
    ab = models.CharField(max_length=200, blank=True, null=True, verbose_name="Addition of two word")
